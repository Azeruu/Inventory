                                                    ...
                                                    <!-- Modal body -->
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                Nama Barang
                                                                <input type="text" name="namabarang" value="<?=$namabarang;?>" class="form-control" required><br>Stok Keluar
                                            ...
                                            <div class="modal fade" id="delete<?=$kodebarang;?>">
                                                <div class="modal-dialog">
                                                    ...
                                                    <!-- Modal body -->
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                Apakah anda yakin ingin menghapus semua data barang keluar dari barang <?=$namabarang;?>?
                                                                <input type="hidden" name="kodebarang" value="<?=$kodebarang;?>">
                                                                <input type="hidden" name="kodebarangkeluar" value="<?=$kodebarangkeluar;?>"><br>
                                                                <br>
      ...
      <form method="post">
            ...
            Pilih Kode Barang<br>
                <select name="kodenya" class="form-control">
                    ...
                    <option value ="<?=$namabarangnya;?>"><?=$kodebarangnya;?></option>
                    <?php
                        }
                    ?>
                </select><br>
